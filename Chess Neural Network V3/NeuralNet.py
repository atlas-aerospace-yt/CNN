    ...
    def saveGamePosition(self, item, file, engine):
        ...
        for position in os.listdir(f"Engine{engine}/Training"):
            ...
            if nn.array_equal(oldPosition, newPosition):
                ...
                nn.save(f"Engine{engine}/Training/{position}/Move.npy", move)
        ...
        if save:
            ...
            nn.save(f"Engine{engine}/Training/Position{amountOfFile+1}/Move.npy", move)
        ...
        while True:
            ...
            for dir in os.listdir(f"Engine{engine}/Training"):
                ...
                try:
                    ...
                    actual = nn.load(f"Engine{engine}/Training/{dir}/Move.npy")
